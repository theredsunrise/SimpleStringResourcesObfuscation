...
not be encrypted by the scripts can be marked with the skip attribute: `<string skip="true" ...>...</string>`.
...
For signing the `obfuscate` project, you need to add your own `keystore.jks` along with
`keystore.properties` file containing the following properties:
